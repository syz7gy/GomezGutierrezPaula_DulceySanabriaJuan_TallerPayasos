...
public class EditComMenu extends JFrame{
	
	private JPanel panel;
	private JLabel foto1;
	private Image img1, img2;
	private Icon icon, icon2;
	private JTextField cc, names, educationLevel;
	...
	public EditComMenu() {
		...
		img1 = new ImageIcon("src/main/java/co/edu/unbosque/view/images/Editcommenu.png").getImage();
