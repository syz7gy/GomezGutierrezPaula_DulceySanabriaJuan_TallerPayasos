...
public class EditPayMenu extends JFrame{
	...
	public EditPayMenu() {
		...
		img1 = new ImageIcon("src/main/java/co/edu/unbosque/view/images/Editclownmenu.png").getImage();
		...
		cantexistencia.setBounds(773, 403, 170, 30);
