...
public class AddComedian extends JFrame{
	...
	public AddComedian() {
		...
		img1 = new ImageIcon("src/main/java/co/edu/unbosque/view/images/Addcomedian.png").getImage();
		...
		cantexistencia.setBounds(283, 543, 170, 30);
